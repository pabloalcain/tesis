...
En este capítulo utilizamos distintas herramientas morfológicas y termodinámicas para caracterizar la materia de estrellas de neutrones simétrica.

\subsection{Herramientas Morfológicas}

Una de las herramientas morfológicas que utilizamos son los funcionales de Minkowski.
...
Para tres dimensiones, esta nurmoalización es la densidad multiplicada por el volumen de un cascarón esférico.
...
\begin{figure}%[H]
  \centering \includegraphics[width=0.4\columnwidth]{transicion/euler-curv.pdf}
