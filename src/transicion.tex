...
Como los primeros picos (correspondientes a los primeros vecinos) están en la misma posición más allá de la temperatura, comcluimos que el orden corto está presente tanto sobre como bajo la transición.
...
\begin{figure}[floatfix]  \centering
  \includegraphics[width=0.7\columnwidth]{transicion/critical_temperature.pdf}
