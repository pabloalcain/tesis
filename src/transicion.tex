...
La figura~\ref{fig:energia} presenta la energía como función de la temperatura (curva calórica) para distintas densidades.
...
Como ejemplo, en la figura~\ref{fig:lind_energ} mostramos el coeficiente de Lindemann junto a la energía para $\rho=0.05\,\text{fm}^{-3}$.
...
\includegraphics[width=0.7\columnwidth]{transicion/energia.pdf}
...
\begin{figure}[h!]  \centering
\includegraphics[width=0.7\columnwidth]{transicion/lind_energ.pdf}
...
$\rho=0.05\,\text{fm}^{-3}$ en la figura~\ref{fig:euler_curv}.
...
\begin{figure}%[H]
  \centering \includegraphics[width=0.7\columnwidth]{transicion/euler_curv.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\columnwidth]{transicion/temperatura_critica.pdf}
...
En la figura~\ref{fig:pico_ssf} graficamos la altura del pico del factor de estructura para momentos bajos $S(k<0.5\,\text{fm}^{-1})$ ($\lambda\gtrsim13\,\text{fm}$) como función de la temperatura para $\rho=0.05\,\text{fm}^{-3}$.
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\columnwidth]{transicion/pico_ssf.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\columnwidth]{transicion/pico_ssf_zoom.pdf}
...
La transición descripta en la sección~\ref{phase_transition} se manifiesta en la figura~\ref{fig:pico_ssf} a partir de la ausencia de fluctuaciones para temperaturas menores a la de transición $T \lesssim 0.5\,\text{MeV}$.
...
Podemos observar en detalle la altura del pico de  $S(k)$ para esta región de temperaturas en la figura~\ref{fig:pico_ssf_zoom} y las estructuras que corresponden a cada una de las simulaciones en la figura~\ref{fig:cool_morph} (ver epígrafe para detalles).
