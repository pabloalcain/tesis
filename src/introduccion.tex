...
Cuando la masa del núcleo alcanza el límite de Chandrasekhar de aproximadamente $1.4\,M_\odot$, los electrones se vuelve ultra-relativistas y no pueden seguir soportando el núcleo a través de la presión de degeneración.
...
\begin{figure}[h]
  ...
  \caption{Energías de ligadura de núcleos obtenidas con CMD, extraída de Ref.~\cite{dorso_isoscaling_2011}.}
\label{fig:binding}
\end{figure}
